...
protected $I = 0;
protected $U = 0;
	var $gradeSignataire="Administrateur Civil Officierde l'ordre de l'Etat",$signataire="Kouka jérémie OUEDRAOGO",$fctSignataire="P.Le Gouverneur et P/D Le Secrétaire Général",$nom="",$groupe="",$fonction="",$grade="",$lieu="",$motif="",$vehicule="",$chauffeur="",$datedepar="",$dateretour="";
