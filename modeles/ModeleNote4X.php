...
protected $U = 0;
	...
	public function Body()
	{
		...
		$this->SetY(145);
		$this->SetX(10);
		$this->Cell(45,15,"Titre1",1,0,"C");
		
		$this->SetY(145);
		$this->SetX(55);
		$this->Cell(45,15,"Titre2",1,0,"C");
		
		$this->SetY(145);
		$this->SetX(100);
		$this->Cell(45,15,"Titre3",1,0,"C");
		
		$this->SetY(145);
		$this->SetX(145);
		$this->Cell(45,15,"Titre4",1,0,"C");
