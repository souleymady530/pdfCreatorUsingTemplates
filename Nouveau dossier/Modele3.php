...
class Modele3 extends FPDF
{
	...
	protected $U = 0;
	public $chemin="";
	public $ref="", $gradeSignataire="",$signataire="",$fctSignataire="La Directrice Régionale",$nom="",$groupe="",$fonction="",$grade="",$lieu="",$motif="",$vehicule="",$chauffeur="",$datedepar="",$dateretour="";
