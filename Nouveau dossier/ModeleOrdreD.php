...
class ModeleOrdreD extends FPDF
{
...
protected $I = 0;
protected $U = 0;
	public $chemin="", $gradeSignataire="Administrateur Civil Officierde l'ordre de l'Etat",$signataire="Kouka jérémie OUEDRAOGO",$fctSignataire="P.Le Gouverneur et P/D Le Secrétaire Général",$nom="",$groupe="",$fonction="",$grade="",$lieu="",$motif="",$vehicule="",$chauffeur="",$datedepar="",$dateretour="";
	...
	function Header()
	{
		...
		$this->addTextHeaderLeft("------------------");
		$this->addTextHeaderLeft("GOUVERNORAT DE OUAHIGOUYA");
		$this->addTextHeaderLeft("-------------------");
		$this->addTextHeaderLeft("SECRETARIAT GENERAL");
		$this->addTextHeaderLeft("-------------------");
		$this->addTextHeaderLeft("N°".date("Y")."-______________/MATD/RNRD/GVR-OHG/SG");
	...
	function SetStyle($tag, $enable)
{
    ...
    { 
		...
		$this->SetY(-50);
        $this->SetX(125);
		$this->MultiCell(50,5,utf8_decode($this->fctSignataire),0,'C');
		...
		// Page number
		$this->Cell(0,10,utf8_decode($this->gradeSignataire),0,0,'C');
    } 
}
