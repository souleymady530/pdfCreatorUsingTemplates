...
protected $U = 0;
	...
	public function Body()
	{
		...
		$this->SetY(145);
		$this->SetX(10);
		$this->Cell(60,5,utf8_decode($this->col1),1,0,"C");
		
		$this->SetY(145);
		$this->SetX(70);
		$this->Cell(60,5,utf8_decode($this->col2),1,"C");
		
		$this->SetY(145);
		$this->SetX(130);
		$this->Cell(60,5,utf8_decode($this->col3),1,0,"C");
